...
import {
  ...
  LogOut, X, ChevronRight, Settings, Calendar, Package, Building2
} from 'lucide-vue-next'
import { ref } from 'vue'
import { useAuthStore } from '@/stores/auth'
import ProfileSettingsSheet from '@/components/dashboard/ProfileSettingsSheet.vue'

type TabType = 'tracker' | 'history' | 'crm' | 'creative' | 'context' | 'customs' | 'office'
...
const sections = [
  ...
  },
  {
    ...
    items: [
      { id: 'office' as TabType, label: 'Oficina Virtual', icon: Building2, color: 'text-cyan-500', bg: 'bg-cyan-500/10', show: true },
