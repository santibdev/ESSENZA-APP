  ...
  <Transition name="slide">
    <aside class="
      ...
      <div class="p-4 pb-6 space-y-3 shrink-0">
        <!-- Version Badge -->
        <div class="px-3 py-2 bg-zinc-50 dark:bg-zinc-900/50 rounded-lg border border-zinc-100 dark:border-zinc-800/40">
          <div class="flex items-center justify-between">
            <span class="text-[10px] font-bold text-zinc-400 dark:text-zinc-600 uppercase tracking-widest">Versión</span>
            <span class="text-[11px] font-black text-zinc-900 dark:text-zinc-100 tabular-nums">v{{ $root.appVersion || '1.0.2' }}</span>
          </div>
        </div>
