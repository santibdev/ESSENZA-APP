...
const typeOptions = [
  ...
  { id: 'IMAGE', label: 'Imágenes', icon: Image, color: 'text-purple-500', bg: 'bg-purple-500/10' },
  { id: 'AUDIO', label: 'Audio', icon: Mic, color: 'text-amber-500', bg: 'bg-amber-500/10' },
]

const priorityOptions = [
  { id: 'LOW', label: 'Baja', color: 'text-zinc-500' },
  { id: 'NORMAL', label: 'Normal', color: 'text-blue-500' },
  { id: 'HIGH', label: 'Alta', color: 'text-orange-500' },
  { id: 'URGENT', label: 'Urgente', color: 'text-red-500' },
]
...
async function handleFileUpload(event: Event) {
  ...
  try {
    // Upload to a temp custom id = 0, will be reassigned after creation
        ...
        <div v-if="type">
          ...
          <div class="flex flex-wrap gap-2 mb-2">
            ...
            <label class="w-20 h-20 rounded-lg border-2 border-dashed border-zinc-300 dark:border-zinc-600 flex flex-col items-center justify-center cursor-pointer hover:border-primary transition-colors">
              ...
              <span class="text-[10px] text-zinc-400 mt-1">Subir</span>
